 ...
 * obtains the data from the {@link android.content.ContentProvider} by
...
public interface Model {
     ...
     */
    public Loader<Cursor> createCursorLoader(UserActionEnum userActionEnum, Uri uri, Bundle args);
